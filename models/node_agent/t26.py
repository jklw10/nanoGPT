...
def run_tracking_task(sweep, dim=16, num_seeds=8):
    ...
    for seed in range(num_seeds):
        ...
        for step in range(total_steps):
            ...
            base_noise=base_noise*utils.wrapping_gaussian_kernel2(base_noise,1.0,0.1)
